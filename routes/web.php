...
Route::add(['GET','POST'],'/appointmentsp', [Controller\Site::class, 'patientAppointments'])->middleware('auth');
Route::add(['GET','POST'],'/appointmentsd', [Controller\Site::class, 'doctorAppointments'])->middleware('doctor');
