        ...
        <div class="form-container d-flex flex-column ">
            <form class="row g-3" method="post">
                ...
                <div class="col-12">
                    ...
                    <select class="form-control rounded-pill" id="exampleFormControlSelect1" name="role_id">
                        <option label="Пациент">1</option>
                        <option label="Доктор">2</option>
                        <option label="Админ">3</option>
                    </select>
                </div>
                <div class="col-12">
